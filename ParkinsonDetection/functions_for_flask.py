############### Usage #################
# python functions_for_flask.py --dataset Output
...
trainingPath = os.path.sep.join([args["dataset"], "train"])
testingPath = os.path.sep.join([args["dataset"], "val"])
...
length_of_test_path = 2 * len(testingPath)
random_select_image = int(uniform(0, length_of_test_path))
test_image_name = testingPaths[random_select_image]
exact_name = test_image_name.split(os.path.sep)[-1]
